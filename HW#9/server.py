...
from config import IP, PORT, MAX_QUEUE, MAX_DB_CONNECTION
...
import socket
from threading import Thread, BoundedSemaphore, RLock, Event

PATH = 'file_db/'
lock = RLock()
event = Event()
semaphore = BoundedSemaphore(MAX_DB_CONNECTION)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        client_thread = Thread(target=main_loop_server, args=(conn, library))
        client_thread.start()
